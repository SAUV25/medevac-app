        ...
        <div className="space-y-6 relative pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Personnalisez le matériel et les vérifications pour chaque type de véhicule et poste.</p>
                </div>
                
                <div className="bg-gray-200 dark:bg-gray-800 p-1 rounded-lg inline-flex">
                    <button
                        onClick={() => !isDirty ? setActiveTab('nurse') : addNotification("Sauvegardez d'abord les changements.", 'warning')}
                    ...
                    <button
                        onClick={() => !isDirty ? setActiveTab('ambulancier') : addNotification("Sauvegardez d'abord les changements.", 'warning')}
                        className={`flex items-center px-4 py-2 rounded-md text-sm font-bold transition-all ${
                    ...
                    <button
                        onClick={() => !isDirty ? setActiveTab('pma') : addNotification("Sauvegardez d'abord les changements.", 'warning')}
                        className={`flex items-center px-4 py-2 rounded-md text-sm font-bold transition-all ${
                            activeTab === 'pma' 
                    ...
                    >
                        <Tent size={16} className="mr-2" /> Poste de Secours (DPS)
                    </button>
                </div>
            </div>
